    ...
    <div>
        <main class="overflow-hidden ">
            ...
            <div class="breadcrumb-area"
                 style="background-image: url(http://localhost:5173/src/assets/images/inner-pages/breadcum-bg.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="product-categories-one__inner">
                                <ul>
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img1.png"
                                                alt=""/></div>
                                    </a>
                                    ...
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img2.png"
                                                alt=""/></div>
                                    </a>
                                        <div class="title"><a href="#0">
                                            <h6>Furnitures</h6>
                                    ...
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img3.png"
                                                alt=""/></div>
                                    </a>
                                        <div class="title"><a href="#0">
                                            <h6>Jewellery</h6>
                                    ...
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img4.png"
                                                alt=""/></div>
                                    </a>
                                        <div class="title"><a href="#0">
                                            <h6>Shoes</h6>
                                    ...
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img5.png"
                                                alt=""/></div>
                                    </a>
                                        <div class="title"><a href="#0">
                                            <h6>Electronics</h6>
                                    ...
                                    <li><a href="#0" class="img-box">
                                        <div class="inner"><img
                                                src="http://localhost:5173/src/assets/images/shop/product-categories-v1-img6.png"
                                                alt=""/></div>
                                    </a>
                                        <div class="title"><a href="#0">
                                            <h6>Fashion</h6>
                                                ...
                                                <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                                                    <div class="products-three-single w-100  mt-30">
                                                        <div class="products-three-single-img"><a
                                                            ...
                                                            <img src="http://localhost:5173/src/assets/images/home-three/productss2-hover-1.png"
                                                                 alt="" class="hover-img"/>
                                                        </a>
                                                            <div class="products-grid-one__badge-box"> <span
                                                                    class="bg_base badge new ">New</span>
                                                            </div>
                                                            <a @click.prevent="addToСart(product.id, true)"
                                                               href="cart.html" class="addcart btn--primary style2">
                                                                Add To Cart </a>
                                                                        ...
                                                                        <div class="popup-right-content">
                                                                            ...
                                                                            <div class="color-varient">
                                                                                <template
                                                                                    ...
                                                                                    <a @click.prevent="getProduct(groupProduct.id)"
                                                                                       ...
                                                                                       class="color-name"> <span>{{color.title}}</span>
                                                                                    </a>
                                                                                </template>
                                                                            ...
                                                                            <div class="add-product">
                                                                                ...
                                                                                <div class="button-group">
                                                                                    ...
                                                                                    <button @click.prevent="addToСart(product.id)"
        ...
        methods: {
            ...
            addColor(id) {
                if (!this.colors.includes(id)) {
                    ...
                    this.colors = this.colors.filter(elen => {
                        return elen !== id;
                    })
                }
            },
            addTag(id) {
                if (!this.tags.includes(id)) {
                    ...
                    this.tags = this.tags.filter(elen => {
                        return elen !== id;
                    })
                }
            },
                    ...
                    .then(res => {
                        ...
                        if ($("#price-range").length) {
                            $("#price-range").slider({
                                ...
                                values: [0, this.filterList.price.max],
